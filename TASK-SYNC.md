...
| 2026-05-20 | Kimi Claw | **E2E TEST BLOCKED** — Backend on Render returns 404 for /api/login and /api/login/verify. Auth endpoints not accessible. Projects endpoint works (200). Need GCSC ClawDesctop to verify auth routes deployment. |
